class Level3 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('insidebg3', 'insidebg3.png')
    ...
    create() {
        ...
        let neededParfaitText = this.add.text(860, 270, `x${requiredParfait - turnedInParfait}`, { fontSize: '24px', stroke: '#0000000', strokeThickness: 3 });
