class mainMenuCinematics extends Phaser.Scene {
    constructor() {
        super('mainmenucinematics');
    }
    ...
    create() {
        ...
        let playButton = this.add.image(1920 / 2, 600, 'play').setScale(.5).setOrigin(.5);
            ...
            playButton.on("pointerdown", () => {
                ...
                this.time.delayedCall(1000, () => this.scene.start('level1cinematics'));
            });
        ...
        let creditsButton = this.add.rectangle(1920 / 2, 1010, 100, 40, 0xffffff).setScale(2).setOrigin(0.5);
            ...
            creditsButton.on("pointerdown", () => {
                this.sound.play('button');
                this.cameras.main.fade(1000, 0, 0, 0);
                this.time.delayedCall(1000, () => this.scene.start('creditscinematics'));
            });
