class Level1SceneFlow extends Phaser.Scene {
    constructor() {
        super('level1sceneflow');
    }
    ...
    create() {
        ...
        replayButton.on('pointerdown', () => {
            ...
            this.time.delayedCall(1000, () => this.scene.start('replaysceneflow'));
        });
        ...
        level2Button.on('pointerdown', () => {
            this.cameras.main.fade(1000, 0, 0, 0);
            this.time.delayedCall(1000, () => this.scene.start('level2sceneflow'));
        });
